...
\newcommand{\titel}{Out-of-Distribution Detection for Chest X-ray Images using Self-Supervised Feature Learning}
...
%\input{appendix}Self-Supervised Out-of-Distribution Detection of Chest X-ray Images
