...
\newcommand{\titel}{
	\begin{spacing}{1.2}
		Out-of-Distribution Detection for Chest X-ray Images with Self-Supervised \\Learning
		%Out-of-Distribution Detection for Chest X-ray Images using Self-Supervised \\Learning
	\end{spacing}
}

% Geben Sie das Datum des Beginns und Ende der Bachelorarbeit ein:
\newcommand{\beginndatum}{8. Dezember 2022}
\newcommand{\abgabedatum}{8.~Juni~2023}

% Geben Sie die Namen des Erst- und Zweitgutachters an:
\newcommand{\erstgutachter}{Prof. Dr.~Markus Kollmann}
\newcommand{\zweitgutachter}{Dr.~Peter Arndt}
