...
\begin{figure}[ht]
	...
	\begin{subfigure}[t]{\textwidth}
		\includegraphics[width=\textwidth, height=9cm]{figures/setting1-chexpert-norm-dino-v-simclr-barplot.pdf}
		\caption{AUROC 1 values for last epoch for CheXpert normalization}
	...
	Figure \ref{fig:setting1-chexnorm-v-imgnorm-dino-barplot} depicts the results for both models restricted to CheXpert normalization only.
...
\begin{figure}[ht]
	\centering
    \includegraphics[width=\textwidth]{figures/auroc-vs-k.pdf}
    \caption{AUROC of settings 1-3 in relation to the number of nearest neighbours used for feature similarity.
	The values for setting 1 were calculated as a top-3 average of the six OOD pathologies.
	$N_i$ refers to the length of the in-distribution train dataset of the i-th setting, where $i \in \{1,2,3\}$.
	The temperature is set to 1 for all values.}
    \label{fig:auroc-vs-k}
\end{figure}
%</Figure:auroc-vs-k>

%<*Figure:dino-chexpert-augs-v-default-augs>
\begin{figure}[ht]
	\centering
	\begin{subfigure}[t]{0.49\textwidth}
		\includegraphics[width=\textwidth, height=1.1\textwidth]{figures/dino-chexpert-augs-v-default-augs-eval-metrics.pdf}
		\caption{Evaluation metrics}
		%\label{fig:setting1-chexnorm-v-imgnorm-simclr}
	\end{subfigure}
	\begin{subfigure}[t]{0.49\textwidth}
		\includegraphics[width=\textwidth, height=1.1\textwidth]{figures/dino-chexpert-augs-v-default-augs-loss.pdf}
		\caption{Loss}
