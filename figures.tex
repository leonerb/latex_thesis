...
\begin{figure}[ht]
	...
	\caption{Comparison of the adjusted DINO augmentations and the Rotation augmentations used by [cite google paper].
...
\begin{figure}[ht]
	...
	\caption{Impact of model size on supervised ViT with ImageNet initialization and performance of supervised ($\circ$) and unsupervised (\rlap{+}{\texttimes}) methods.}
\end{figure}
%</Figure:supervised-vs-unsupervised>
