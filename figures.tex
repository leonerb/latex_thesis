...
\begin{figure}[ht]
	...
	\caption{Comparison of the adapted DINO augmentations and additionally adding a rotation by 20 degrees (Rotation augmentations, detailed in \ref{section: adapted-methods}).}
