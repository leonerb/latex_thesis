...
For each image, the pathologies are labeled as positive (1), negative (0) or uncertain (-1), where uncertainty labels express both contradictions in the report as well as diagnostic uncertainty of the radiologist \citep{Irvin2019}.
Labels were extracted automatically from free text radiology reports in three stages.
In the first step, observations were extracted from the reports with the help of a hand-selected list of common phrases \citep{Irvin2019}. 
